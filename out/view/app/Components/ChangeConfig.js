...
const ChangeConfig = (props) => {
    ...
    return (React.createElement("div", { className: "dropdown nav-item" },
        ...
        React.createElement("div", { className: "dropdown-menu  overflow-auto toolBarDropdownBg", "aria-labelledby": "ChangeConfig", style: { minWidth: "180px", maxHeight: "260px" } },
            React.createElement("button", { className: "dropdown-item  btn-custom iconsAndTextAlign ", type: "button", style: { paddingLeft: "1rem" }, "data-bs-toggle": "modal", "data-bs-target": "#EnterFileNameDialog" },
                ...
                "Create New"),
            React.createElement("button", { className: "dropdown-item   btn-custom iconsAndTextAlign ", type: "button", style: { paddingLeft: "1rem" }, onClick: () => {
