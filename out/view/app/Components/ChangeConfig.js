...
const ChangeConfig = (props) => {
    const setConfigFilesList = (configFileList) => {
        ...
        return configFileList.map((item) => {
            return (React.createElement("button", { className: "dropdown-item text-center", type: "button", style: { width: "165px" }, onClick: () => {
    ...
    return (React.createElement("div", { className: "dropdown nav-item", style: { width: "25%", minWidth: "165px", height: "44px", paddingRight: "1rem" } },
        ...
        React.createElement("div", { className: "dropdown-menu", "aria-labelledby": "ChangeConfig", style: { width: "165px" } },
            ...
            props.configDirContentValue ? (setConfigFilesList(window.configFilesDir.directoryContent)) : (React.createElement("div", { className: "text-center", style: { width: "165px" } },
